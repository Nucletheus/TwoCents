...
pub enum ThemePreset {
  OneDark, Nord, Dracula, Catppuccin, CatppuccinMacchiato,
  GitHub, Solarized, Tokyonight, Everforest, Gruvbox,
  Kanagawa, Ayu, Matrix,
}
...
impl ThemePreset {
  pub fn all() -> &'static [(Self, &'static str)] {
    &[
      (Self::OneDark, "One Dark"), (Self::Nord, "Nord"),
      (Self::Dracula, "Dracula"), (Self::Catppuccin, "Catppuccin"),
      (Self::CatppuccinMacchiato, "Catppuccin Macchiato"),
      (Self::GitHub, "GitHub"), (Self::Solarized, "Solarized"),
      (Self::Tokyonight, "Tokyonight"), (Self::Everforest, "Everforest"),
...
#[derive(Clone)]
struct ThemeColors {
  panel_fill: Color32, window_fill: Color32,
  extreme_bg: Color32, faint_bg: Color32, hovered_bg: Color32,
  text_primary: Color32, border: Color32, accent: Color32,
  success: Color32, warning: Color32, error: Color32,
}
...
struct ThemePair { dark: ThemeColors, light: ThemeColors }

// --- One Dark ---
fn one_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x0e0f11), window_fill: hex(0x1a1c20),
    extreme_bg: hex(0x0e0f11), faint_bg: hex(0x1a1c20), hovered_bg: hex(0x2c2e33),
    text_primary: hex(0xf3f4f6), border: hex(0x2c2e33),
    accent: hex(0x3b82f6), success: hex(0x98c379), warning: hex(0xd19a66), error: hex(0xe06c75),
  }
}
fn one_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xf3f4f6), window_fill: hex(0xffffff),
    extreme_bg: hex(0xf3f4f6), faint_bg: hex(0xffffff), hovered_bg: hex(0xe5e7eb),
    text_primary: hex(0x111827), border: hex(0xd1d5db),
    accent: hex(0x2563eb), success: hex(0x16a34a), warning: hex(0xd97706), error: hex(0xdc2626),
  }
}
...
fn nord_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x2e3440), window_fill: hex(0x3b4252),
    extreme_bg: hex(0x2e3440), faint_bg: hex(0x3b4252), hovered_bg: hex(0x434c5e),
    text_primary: hex(0xeceff4), border: hex(0x4c566a),
    accent: hex(0x88c0d0), success: hex(0xa3be8c), warning: hex(0xebcb8b), error: hex(0xbf616a),
  }
}
fn nord_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xeceff4), window_fill: hex(0xf5f7fa),
    extreme_bg: hex(0xeceff4), faint_bg: hex(0xf5f7fa), hovered_bg: hex(0xd8dee9),
    text_primary: hex(0x2e3440), border: hex(0xd8dee9),
    accent: hex(0x5e81ac), success: hex(0x8fbcbb), warning: hex(0xd08770), error: hex(0xbf616a),
  }
}
...
fn dracula_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x1e1f29), window_fill: hex(0x282a36),
    extreme_bg: hex(0x1e1f29), faint_bg: hex(0x282a36), hovered_bg: hex(0x3a3c4e),
    text_primary: hex(0xf8f8f2), border: hex(0x3a3c4e),
    accent: hex(0xbd93f9), success: hex(0x50fa7b), warning: hex(0xf1fa8c), error: hex(0xff5555),
  }
}
fn dracula_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xfaf8f5), window_fill: hex(0xffffff),
    extreme_bg: hex(0xfaf8f5), faint_bg: hex(0xffffff), hovered_bg: hex(0xf0ece6),
    text_primary: hex(0x282a36), border: hex(0xe0dcd6),
    accent: hex(0xbd93f9), success: hex(0x50fa7b), warning: hex(0xf1fa8c), error: hex(0xff5555),
  }
}
...
fn catppuccin_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x11111b), window_fill: hex(0x1e1e2e),
    extreme_bg: hex(0x11111b), faint_bg: hex(0x1e1e2e), hovered_bg: hex(0x313244),
    text_primary: hex(0xcdd6f4), border: hex(0x313244),
    accent: hex(0x89b4fa), success: hex(0xa6e3a1), warning: hex(0xf9e2af), error: hex(0xf38ba8),
  }
}
fn catppuccin_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xeff1f5), window_fill: hex(0xffffff),
    extreme_bg: hex(0xeff1f5), faint_bg: hex(0xffffff), hovered_bg: hex(0xccd0da),
    text_primary: hex(0x1e1e2e), border: hex(0xccd0da),
    accent: hex(0x1e66f5), success: hex(0x40a02b), warning: hex(0xdf8e1d), error: hex(0xd20f39),
  }
}
...
fn macchiato_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x181926), window_fill: hex(0x24273a),
    extreme_bg: hex(0x181926), faint_bg: hex(0x24273a), hovered_bg: hex(0x363a4f),
    text_primary: hex(0xcad3f5), border: hex(0x363a4f),
    accent: hex(0x8aadf4), success: hex(0xa6da95), warning: hex(0xeed49f), error: hex(0xed8796),
  }
}
fn macchiato_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xeff1f5), window_fill: hex(0xffffff),
    extreme_bg: hex(0xeff1f5), faint_bg: hex(0xffffff), hovered_bg: hex(0xccd0da),
    text_primary: hex(0x24273a), border: hex(0xccd0da),
    accent: hex(0x8aadf4), success: hex(0x40a02b), warning: hex(0xdf8e1d), error: hex(0xd20f39),
  }
}
...
fn github_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x0d1117), window_fill: hex(0x161b22),
    extreme_bg: hex(0x0d1117), faint_bg: hex(0x161b22), hovered_bg: hex(0x21262d),
    text_primary: hex(0xe6edf3), border: hex(0x30363d),
    accent: hex(0x58a6ff), success: hex(0x2da44e), warning: hex(0xbf8700), error: hex(0xcf222e),
  }
}
fn github_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xf6f8fa), window_fill: hex(0xffffff),
    extreme_bg: hex(0xf6f8fa), faint_bg: hex(0xffffff), hovered_bg: hex(0xeaeef2),
    text_primary: hex(0x1f2328), border: hex(0xd0d7de),
    accent: hex(0x0969da), success: hex(0x1a7f37), warning: hex(0x9a6700), error: hex(0xcf222e),
  }
}
...
fn solarized_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x002b36), window_fill: hex(0x073642),
    extreme_bg: hex(0x002b36), faint_bg: hex(0x073642), hovered_bg: hex(0x184a54),
    text_primary: hex(0x93a1a1), border: hex(0x184a54),
    accent: hex(0x268bd2), success: hex(0x859900), warning: hex(0xb58900), error: hex(0xdc322f),
  }
}
fn solarized_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xfdf6e3), window_fill: hex(0xfffce5),
    extreme_bg: hex(0xfdf6e3), faint_bg: hex(0xfffce5), hovered_bg: hex(0xe9e2c7),
    text_primary: hex(0x657b83), border: hex(0xd4cfa6),
    accent: hex(0x268bd2), success: hex(0x859900), warning: hex(0xb58900), error: hex(0xdc322f),
  }
}
...
fn tokyonight_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x1a1b26), window_fill: hex(0x24283b),
    extreme_bg: hex(0x1a1b26), faint_bg: hex(0x24283b), hovered_bg: hex(0x33467a),
    text_primary: hex(0xc0caf5), border: hex(0x33467a),
    accent: hex(0x7aa2f7), success: hex(0x9ece6a), warning: hex(0xe0af68), error: hex(0xf7768e),
  }
}
fn tokyonight_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xe1e2e7), window_fill: hex(0xf5f6fa),
    extreme_bg: hex(0xe1e2e7), faint_bg: hex(0xf5f6fa), hovered_bg: hex(0xc9cbd1),
    text_primary: hex(0x1a1b26), border: hex(0xc9cbd1),
    accent: hex(0x565f89), success: hex(0x9ece6a), warning: hex(0xe0af68), error: hex(0xf7768e),
  }
}
...
fn everforest_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x2b3339), window_fill: hex(0x343f44),
    extreme_bg: hex(0x2b3339), faint_bg: hex(0x343f44), hovered_bg: hex(0x47565c),
    text_primary: hex(0xd3c6aa), border: hex(0x47565c),
    accent: hex(0xa7c080), success: hex(0xa7c080), warning: hex(0xdbbc7f), error: hex(0xe67e80),
  }
}
fn everforest_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xfff9e8), window_fill: hex(0xfef6e3),
    extreme_bg: hex(0xfff9e8), faint_bg: hex(0xfef6e3), hovered_bg: hex(0xe8dfc6),
    text_primary: hex(0x5c6a72), border: hex(0xe8dfc6),
    accent: hex(0x83c092), success: hex(0x83c092), warning: hex(0xe6985e), error: hex(0xe67e80),
  }
}
...
fn gruvbox_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x282828), window_fill: hex(0x32302f),
    extreme_bg: hex(0x282828), faint_bg: hex(0x32302f), hovered_bg: hex(0x504945),
    text_primary: hex(0xebdbb2), border: hex(0x504945),
    accent: hex(0xb8bb26), success: hex(0x98971a), warning: hex(0xd79921), error: hex(0xcc241d),
  }
}
fn gruvbox_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xfbf1c7), window_fill: hex(0xf9f5d7),
    extreme_bg: hex(0xfbf1c7), faint_bg: hex(0xf9f5d7), hovered_bg: hex(0xebdbb2),
    text_primary: hex(0x3c3836), border: hex(0xebdbb2),
    accent: hex(0x98971a), success: hex(0x79740e), warning: hex(0xb57614), error: hex(0x9d0006),
  }
}
...
fn kanagawa_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x1f1f28), window_fill: hex(0x2a2a37),
    extreme_bg: hex(0x1f1f28), faint_bg: hex(0x2a2a37), hovered_bg: hex(0x363646),
    text_primary: hex(0xdcd7ba), border: hex(0x363646),
    accent: hex(0x7e9cd8), success: hex(0x76946a), warning: hex(0xc0a36e), error: hex(0xc34043),
  }
}
fn kanagawa_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xf2ecbc), window_fill: hex(0xfaf3d1),
    extreme_bg: hex(0xf2ecbc), faint_bg: hex(0xfaf3d1), hovered_bg: hex(0xe4d9a0),
    text_primary: hex(0x2d2b2a), border: hex(0xe4d9a0),
    accent: hex(0x2d4f67), success: hex(0x76946a), warning: hex(0xc0a36e), error: hex(0xc34043),
  }
}
...
fn ayu_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x0b0e14), window_fill: hex(0x131721),
    extreme_bg: hex(0x0b0e14), faint_bg: hex(0x131721), hovered_bg: hex(0x1f2430),
    text_primary: hex(0xbfc8d5), border: hex(0x1f2430),
    accent: hex(0x39bae6), success: hex(0x7fd962), warning: hex(0xffd580), error: hex(0xf07178),
  }
}
fn ayu_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xfafafa), window_fill: hex(0xffffff),
    extreme_bg: hex(0xfafafa), faint_bg: hex(0xffffff), hovered_bg: hex(0xeaeaea),
    text_primary: hex(0x1a1f29), border: hex(0xeaeaea),
    accent: hex(0x399ee6), success: hex(0x6bb75b), warning: hex(0xe6b450), error: hex(0xef6b68),
  }
}
...
fn matrix_dark() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0x000000), window_fill: hex(0x0a0a0a),
    extreme_bg: hex(0x000000), faint_bg: hex(0x0a0a0a), hovered_bg: hex(0x001a00),
    text_primary: hex(0x00ff41), border: hex(0x003b00),
    accent: hex(0x00ff41), success: hex(0x00ff41), warning: hex(0xffff00), error: hex(0xff0000),
  }
}
fn matrix_light() -> ThemeColors {
  ThemeColors {
    panel_fill: hex(0xf0fff0), window_fill: hex(0xffffff),
    extreme_bg: hex(0xf0fff0), faint_bg: hex(0xffffff), hovered_bg: hex(0xd0ffd0),
    text_primary: hex(0x003b00), border: hex(0x00aa41),
    accent: hex(0x00cc44), success: hex(0x00cc44), warning: hex(0xaaaa00), error: hex(0xcc0000),
  }
}

fn theme_pair(t: ThemePreset) -> ThemePair {
  match t {
    ThemePreset::OneDark => ThemePair { dark: one_dark(), light: one_light() },
    ThemePreset::Nord => ThemePair { dark: nord_dark(), light: nord_light() },
    ThemePreset::Dracula => ThemePair { dark: dracula_dark(), light: dracula_light() },
    ThemePreset::Catppuccin => ThemePair { dark: catppuccin_dark(), light: catppuccin_light() },
    ThemePreset::CatppuccinMacchiato => ThemePair { dark: macchiato_dark(), light: macchiato_light() },
    ThemePreset::GitHub => ThemePair { dark: github_dark(), light: github_light() },
    ThemePreset::Solarized => ThemePair { dark: solarized_dark(), light: solarized_light() },
    ThemePreset::Tokyonight => ThemePair { dark: tokyonight_dark(), light: tokyonight_light() },
    ThemePreset::Everforest => ThemePair { dark: everforest_dark(), light: everforest_light() },
    ThemePreset::Gruvbox => ThemePair { dark: gruvbox_dark(), light: gruvbox_light() },
    ThemePreset::Kanagawa => ThemePair { dark: kanagawa_dark(), light: kanagawa_light() },
    ThemePreset::Ayu => ThemePair { dark: ayu_dark(), light: ayu_light() },
    ThemePreset::Matrix => ThemePair { dark: matrix_dark(), light: matrix_light() },
  }
}
